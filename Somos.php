    ...
    <div class="container">
       <div class="row">
          <div class="col-md-8 col-md-offset-1 text-center">
            ...
            <p>Somos un grupo de médicos profesionales comprometidos con la salud de nuestros pacientes que damos calidad en nuestra atención y trato humanitario.</p>
          
            <h4 class="title">Misión Visión y Valores</h4>
            <p>Tener una atención de calidad y lograr la recuperación de la salud de nuestros pacientes.</p>
            <p>Ser líderes a nivel local de la atención médica a pacientes</p>
            <p>Responsabilidad, Profesionalismo y Horadez</p>
