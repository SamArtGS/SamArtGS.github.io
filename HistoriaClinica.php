                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-info pull-right"  href="EditarHC.php?id=<?php echo $id; ?>">
                                    <i class="material-icons">create</i> Editar Perfil
                                </a>
                            <div class="card">
                                <div class="card-header" data-background-color="azul">
                                    <h4 class="title">Historia Clínica</h4>
                                    <p class="category">Datos relacionados a los antecedentes del paciente</p>
                                </div>
